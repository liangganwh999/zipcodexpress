...
function getConnection() {
	...
	global $db_zipcodexpress_db_Url, $db_zipcodexpress_db_User, $db_zipcodexpress_db_Pass, $db_zipcodexpress_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_zipcodexpress_db_Url.";dbname=".$db_zipcodexpress_db_DbName, $db_zipcodexpress_db_User, $db_zipcodexpress_db_Pass);
